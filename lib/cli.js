...
var OptionParser, argv, codeIn, coffeecup, compile, fs, handle_error, log, options, path, stdin, switches, usage, watch, write;
...
this.run = function() {
  ...
  if (options.stdin) {
    stdin.on('data', function(buffer) {
      if (buffer) {
        return codeIn += buffer.toString();
      }
    });
    stdin.on('end', function() {
      return log(coffeecup.render(codeIn));
    });
  }
  if (options.utils) {
